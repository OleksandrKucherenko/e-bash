...
# - ~0.5-1s Linux process spawning overhead
# Total expected: 2-3s on Linux runners
if [[ $DURATION -lt 3 ]]; then
    ...
    log_error "Verification failed: test did not timeout (Duration: ${DURATION}s, expected <3s)"
