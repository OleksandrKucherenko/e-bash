...
- [ ] Add remote `tap`: `git remote add tap https://github.com/artfulbits-se/homebrew-tap.git`
- [ ] Fetch remote: `git fetch tap`
- [ ] Create worktree: `git worktree add .worktrees/homebrew-tap tap/master` (or `main`)
- [ ] Ensure `.worktrees/` is in `.gitignore`.

### 4.2 Repository Initialization
- [ ] If empty, initialize `homebrew-tap` with `Formula/` folder and `README.md`.
- [ ] Create initial `Formula/e-bash.rb`.
