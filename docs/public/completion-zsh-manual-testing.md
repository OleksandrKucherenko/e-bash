...
Test subject: `demos/completion/demo.completion.sh`
...
ln -sf "$REPO/demos/completion/demo.completion.sh" "$HOME/.local/bin/demo.completion.sh"
chmod +x "$REPO/demos/completion/demo.completion.sh"
...
```bash
"$REPO/demos/completion/demo.completion.sh" --generate-completion zsh > /tmp/_demo_completion_sh
...
```bash
"$REPO/demos/completion/demo.completion.sh" --install-completion zsh
```
