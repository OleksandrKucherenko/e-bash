...
See `demos/completion/demo.completion.sh` for a working example:
...
demos/completion/demo.completion.sh --generate-completion bash
demos/completion/demo.completion.sh --generate-completion zsh
```
