...
echo
echo "⚠️  CRITICAL DEPENDENCY ORDER:"
echo "   1. Homebrew must be installed FIRST (Linux systems)"
echo "   2. DIRENV must be installed SECOND"
echo "   3. Only then can .envrc be executed safely"
echo "   4. .envrc contains brew-based dependency installations"
echo
...
echo "📦 DIRENV Integration (with proper dependency order):"
echo "   # CRITICAL: Install dependencies in correct order!"
echo "   # 1. Install Homebrew first (required by .envrc dependencies)"
echo "   /bin/bash -c \"\$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/HEAD/install.sh)\""
echo "   echo \"/home/linuxbrew/.linuxbrew/bin:/home/linuxbrew/.linuxbrew/sbin\" >> \"\$GITHUB_PATH\""
echo "   # 2. Install DIRENV second"
echo "   curl -sfL https://direnv.net/install.sh | bash"
echo "   echo \"\$HOME/.local/bin\" >> \"\$GITHUB_PATH\""
echo "   # 3. Load project environment with auto-install"
