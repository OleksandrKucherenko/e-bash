...
if [[ "$help" == "1" ]]; then
  ...
  echo ""
  echo "Usage: demos/completion/demo.completion.sh [flags]"
  echo ""
  print:help
  exit 0
fi
...
Samples:
  demos/completion/demo.completion.sh --help
  demos/completion/demo.completion.sh --verbose -o result.txt -f json

Completion (auto-dispatched by args:dispatch):
  demos/completion/demo.completion.sh --completion bash
  demos/completion/demo.completion.sh --completion zsh
  demos/completion/demo.completion.sh --install-completion bash
  demos/completion/demo.completion.sh --install-completion zsh
