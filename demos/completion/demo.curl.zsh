#compdef demo-curl demo.curl.sh demos/completion/demo.curl.sh ./demos/completion/demo.curl.sh

# Zsh completion for demo.curl.sh
# Usage (zsh):
#   autoload -Uz compinit && compinit
#   source demos/completion/demo.curl.zsh
