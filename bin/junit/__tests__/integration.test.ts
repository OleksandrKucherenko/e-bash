...
describe("Integration: End-to-end workflow", () => {
    ...
    test("example-level chunking provides finer distribution", () => {
        const xml = `
      <testsuites>
        <testcase classname="spec/big_spec.sh" name="test 1" time="10.0"/>
        <testcase classname="spec/big_spec.sh" name="test 2" time="10.0"/>
        <testcase classname="spec/big_spec.sh" name="test 3" time="10.0"/>
        <testcase classname="spec/big_spec.sh" name="test 4" time="10.0"/>
        <testcase classname="spec/small_spec.sh" name="test 1" time="2.0"/>
      </testsuites>
    `;
